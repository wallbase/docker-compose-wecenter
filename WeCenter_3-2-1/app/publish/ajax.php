...
class ajax extends AWS_CONTROLLER
{
    ...
    public function publish_article_action()
    {
        ...
        if (get_setting('upload_enable') == 'Y' AND!$_POST['logo_img'] AND !$_POST['is_suggest']) {
        ...
        if ($this->publish_approval_valid(array(
            ...
            $article_id = $this->model('publish')->publish_article($_POST['title'],$_POST['logo_img'], $_POST['message'], $this->user_id, $_POST['topics'], $_POST['category_id'], $_POST['column_id'], $_POST['attach_access_key'], $this->user_info['permission']['create_topic']);
    ...
    public function modify_article_action()
    {
        ...
        $this->model('article')->update_article($article_info['id'], $this->user_id, $_POST['title'],$_POST['logo_img'], $_POST['message'], $_POST['topics'], $_POST['category_id'], $_POST['column_id'], $this->user_info['permission']['create_topic']);
